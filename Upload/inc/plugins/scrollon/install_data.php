...
$templates = array(
	...
	<div id="scrollon" style="display: none;">
		<span>{\$show_more}</span><span id="scrollon_no_posts"{\$no_post_style}>{\$lang->scrollon_no_new_posts}</span><span id="scrollon_spinner" style="display: none;"><img src="{\$theme['imgdir']}/scrollon/spinner.gif" alt="{\$lang->scrollon_loading}"/></span>
	</div>
